	...
	<div class="u-column1 col-md-<?php echo (int) $col; ?>">
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-form-login__submit btn btn-primary" name="login" value="<?php esc_attr_e( 'Log in', 'understrap' ); ?>"><?php esc_html_e( 'Log in', 'understrap' ); ?></button>
			</p>
	...
	<div class="u-column2 col-md-6">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php else : ?>
				...
				<p><b><?php esc_html_e( 'A password will be sent to your email address.', 'understrap' ); ?></b></p>
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit" class="woocommerce-form-register__submit btn btn-primary" name="register" value="<?php esc_attr_e( 'Register', 'understrap' ); ?>"><?php esc_html_e( 'Register', 'understrap' ); ?></button>
			</p>
