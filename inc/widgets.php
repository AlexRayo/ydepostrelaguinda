	...
	function understrap_widgets_init() {		
		...
		register_sidebar(
			array(
				...
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s dynamic-classes px-md-4 mb-5 mb-lg-0">',
		...
		register_sidebar(
			array(
				'name'          => 'Bottom Block',
				'description'   => 'Add the bottom widget here',
		...
		register_sidebar(
			array(
				'name'          => 'Header Cart',
				'description'   => 'Add the cart widget here',
				'before_widget' => '<div id="header_cart" class="">',
				'after_widget'  => '</div>',
				'before_title'  => '<h3 class="d-none">',
				'after_title'   => '</h3>',
			)
		...
		register_sidebar(
			array(
				'name'          => 'Slider',
				'description'   => 'Add some info to the second slide',
				'before_widget' => '<li class="d-block splide__slide p-lg-5"><div class="overflow-hidden" style="max-height: 500px">',
				'after_widget'  => '</div></li>',
		...
		register_sidebar(
			array(
				'name'          => 'Home Category',
				'description'   => 'Add some category block to homepage',
				'before_widget' => '<div class="p-3 col-12 col-md-4"><div class="bg-gray p-4">',
		...
		register_sidebar(
			array(
				'name'          => 'Last Blocks home',
				'description'   => 'Add some text block',
				'before_widget' => '<div class="mb-3 p-0 p-md-5 col-12 col-md-4"><div class="p-4">',
				'after_widget'  => '</div></div>',
				'before_title'  => '<h2 class="d-none">',
				'after_title'   => '</h2>',
			)
